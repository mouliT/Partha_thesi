...
We write one section/subsection at a time. If you do not explicitly approve a
section, the next section will not be written.
\end{warningbox}

\begin{statebox}[Assets]
Figures are extracted into `figures/` with filenames like
`Parth\_ch2\_Fig2\_15\_page64.png`.
The figure context index is in `figures/Parth\_ch2\_context.md`.
\end{statebox}
